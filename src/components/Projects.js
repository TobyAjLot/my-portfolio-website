    ...
    <section id="projects" className="text-gray-100 bg-blue-950 body-font">
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        <div className="flex flex-col w-full mb-20">
          ...
          <div className="w-full flex flex-wrap px-2 my-4">
            <div className="relative w-full lg:w-1/2 p-2 flex items-center">
              <img src={Todo} alt="gallery" className="rounded-lg" />
              <div className="px-8 py-2 absolute z-10 w-full bg-gray-900 opacity-0 duration-300 hover:opacity-100 rounded-lg inset-0">
            ...
            <div className="relative w-full lg:w-1/2 p-2 flex items-center">
              <img src={Secrets} alt="gallery" className="rounded-lg" />
              <div className="px-8 py-10 absolute z-10 w-full bg-gray-900 opacity-0 duration-300 hover:opacity-100 rounded inset-0">
                <h1 className="title-font text-3xl font-medium text-white mb-3">
                  Secrets App
                </h1>
                <div className="w-full h-auto relative text-center">
                  ...
                  <ul className="technologies mb-8">
                    <li> Express JS</li>
                    <li> MD5 </li>
                    <li> MongoDB</li>
                    <li> Google-OAuth2 </li>
            ...
            <div className="relative w-full lg:w-1/2 p-2 flex items-center">
              <img src={Blog} alt="gallery" className="rounded-lg" />
              <div className="px-8 py-10 absolute z-10 w-full bg-gray-900 opacity-0 duration-300 hover:opacity-100 rounded inset-0">
                <h1 className="title-font text-3xl font-medium text-white mb-3">
                  Tobi's Blog
                </h1>
            ...
            <div className="relative w-full lg:w-1/2 p-2 flex items-center">
              <img src={Dicegame} alt="gallery" className="rounded-lg" />
              <div className="px-8 py-10 absolute z-10 w-full bg-gray-900 opacity-0 duration-300 hover:opacity-100 rounded inset-0">
                <h1 className="title-font text-3xl font-medium text-white mb-3">
                  Dice Game
                </h1>
            ...
            <div className="relative w-full lg:w-1/2 p-2 flex items-center">
              <img src={Simongame} alt="gallery" className="rounded-lg" />
              <div className="px-8 py-10 absolute z-10 w-full bg-gray-900 opacity-0 duration-300 hover:opacity-100 rounded inset-0">
                <h1 className="title-font text-3xl font-medium text-white mb-3">
                  Simon Game
                </h1>
            ...
            <div className="relative w-full lg:w-1/2 p-2 flex items-center">
              <img src={Drumkit} alt="gallery" className="rounded-lg" />
              <div className="px-8 py-10 absolute z-10 w-full bg-gray-900 opacity-0 duration-300 hover:opacity-100 rounded inset-0">
                <h1 className="title-font text-3xl font-medium text-white mb-3">
                  Drumkit
                </h1>
